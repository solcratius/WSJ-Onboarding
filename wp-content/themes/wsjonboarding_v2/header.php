<?php
/**
 * The Header template for the WSJONBOARDING_V2
 *
 * Displays all of the <head> section and everything up till <div id="main">
 *
 * @package WSJONBOARDING_V2
 */

 $mainID = $post->ID;//get_page_by_title( 'Main' )->ID;
?><!DOCTYPE html>
<!--[if IE 7]>
...
<body id="top" <?php body_class(); ?>>
  ...
  ?>>
    ...
    ?>>
      ...
      <h1><a href="<?php echo get_permalink ($mainID); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"<?php 
